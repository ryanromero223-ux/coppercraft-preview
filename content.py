...
PAGES = {
    ...
    "9-year": {
        ...
        "meta_desc": "A real 9-year age statement, printed on the front of the bottle. 90.6 proof, $37.99, shipped to your door by a licensed retailer.",
        "sku_name": "Coppercraft 9-Year Straight Bourbon",
        "accent": "#B87333",
        "h1": "Coppercraft 9-Year Straight Bourbon Whiskey",
        "tagline": "A Real 9-Year Age Statement For $37.99",
        ...
        "carousel": [
            ...
            ("assets/9yr-label-closeup.jpg", "The 9-year age statement printed on the label: 90.6 proof, 750 ml"),
        ...
        "mech_cards": [
            ("9 YEARS", "An age statement has to be true. It's federal law. The 9 on this label means nine real years in the barrel."),
        ...
        "mech_img": ("assets/9yr-label-closeup.jpg", "The 9-year age statement on the front label"),
        "quotes": [
        ...
        "compare_rows": [
            ...
            ("The age statement", "9 years", "9 years, printed on the front"),
        ...
        "gift_ps": [
            "You can't taste a bottle before you give it. That's the anxiety. So let the label make your case. A real 9-year age statement reads as quality before the cork even comes out.",
        ...
        "faq": [
            ("Is the 9-year age statement real?",
             "Yes. It's printed on the front label. Federal law requires a printed age statement to be true, so the age on the bottle is the age in the barrel."),
            ...
            ("Will a real bourbon drinker be impressed?",
             "The age statement does that work for you. Nine years in oak is the kind of fact an enthusiast checks first. One critic put it simply: he appreciates seeing an age-stated bourbon under $40."),
